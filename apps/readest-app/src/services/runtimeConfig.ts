...
export const getServerRuntimeConfig = (): ReadestRuntimeConfig => ({
  ...
  nodeBaseUrl: process.env['NODE_BASE_URL'] ?? process.env['NEXT_PUBLIC_NODE_BASE_URL'],
  ...
  wordLensBaseUrl:
    process.env['WORDLENS_BASE_URL'] || process.env['NEXT_PUBLIC_WORDLENS_BASE_URL'] || undefined,
});
